...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.state'
        db.add_column('games_game', 'state', self.gf('dcouch.models.CouchField')(default='', max_length=32, db_name='turnflict', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.state'
